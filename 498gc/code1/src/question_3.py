...
class listenerNode():
    ...
    def __init__(self):
        ...
        self.x = 0.0
        self.y = 0.0
        # 6376422.738613834 -111300.87291226744
        self.x_offset = 152177.5824705489
        self.y_offset = -4868170.269891024
    ...
    def run(self):
        ...
        pub_odom = rospy.Publisher('/q3/odom', Odometry, queue_size=1)
    ...
    def update_position(self):
        ...
        self.x, self.y = latlong_to_position(self.lat, self.long)
